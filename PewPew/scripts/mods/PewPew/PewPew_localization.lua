...
local localizations = {
	...
	missile_launcher = { en=Localize("loc_ability_broker_blitz_missile_launcher") },
	outlaw_missile_launcher_fire = { en=Localize("loc_ability_broker_blitz_missile_launcher") },
