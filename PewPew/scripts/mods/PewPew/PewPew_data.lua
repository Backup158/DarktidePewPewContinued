...
for _, sound_table in pairs(SPECIAL_SHOT_SOUND_EFFECTS_OPTIONS) do
	table_insert(COMBINED_SOUNDS_SINGLE_SPECIAL, sound_table)
end
...
for i = 1, #line_effects_widgets do
	...
	line_effects_widgets[i].default_value = line_effects_widgets[i].setting_id
...
return {
	...
	options = {
		widgets = {
			...
			{ 
				setting_id="sound_effects_id", 
				type="group", 
				sub_widgets=sound_effects_widgets 
			},
			{ 
				setting_id="single_shot_sound_effects_id", 
				type="group", 
				sub_widgets=single_shot_sound_effects_widgets 
			},
			{ 
				setting_id="special_shot_sound_effects_id", 
				type="group", 
				sub_widgets=special_shot_sound_effects_widgets 
			},
			{ 
				setting_id="melee_swing_effects_id", 
				type="group", 
				sub_widgets=melee_sound_effects_widgets 
			},
		},
	},
}